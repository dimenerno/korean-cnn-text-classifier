...
tf.flags.DEFINE_boolean("log_device_placement", True,
                        "Log placement of ops on devices")  # GPU는 TRUE
...
def preprocess():
    ...
    # Load data
    print("Loading data...")
    x_text, x_text_morph, y = data_helpers_double_kernel.load_data_and_labels(
        FLAGS.positive_data_file, FLAGS.negative_data_file, FLAGS.positive_data_file_morph, FLAGS.negative_data_file_morph)
    ...
    x_morph_train, x_morph_dev = x_morph_shuffled[:
                                                  dev_sample_index], x_morph_shuffled[dev_sample_index:]
